...
public class ElectricityCountActivity extends BaseActivity {
    ...
    protected int initContentView() {
        return R.layout.activity_electricity_count;
    }

    @Override
    protected void initView() {
        contentView = findViewById(R.id.electricity_contentView);
        button_menu= (ImageButton) findViewById(R.id.button_menu);
        mRightTitle = (TextView) findViewById(R.id.right_title);
        tv_toolbar= (TextView) findViewById(R.id.tv_toolbar);
        toolbar= (Toolbar) findViewById(R.id.toolbar);
        mWdebView= (WebView) findViewById(R.id.electricity_wb);
        //进行webwiev的一堆设置
